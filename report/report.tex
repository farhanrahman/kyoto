...
\documentclass[fleqn]{article} % use larger type; default would be 10pt
...
\include{sections/OurModel}

\include{sections/Implementation}

\include{sections/Issues}

\include{sections/SimulationResults}

\include{sections/Future Development}
