...
Any individual simulation can be configured in the following ways. These changes allow us to make sweeping changes to outcomes and agent activities without altering implementation of any component of our system. This allows us to construct theoretical alternative scenarios to the real world Kyoto Protocol.
