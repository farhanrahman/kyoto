...
public final class Constants {
	...
	public static final double	PRICE_INITIAL = 1000; // HAVE TO CHANGE THAT
	public static final double	PRICE_SUCCESS_SCALER = 1.5;
	public static final double	PRICE_FAILURE_SCALER = 1.5;
