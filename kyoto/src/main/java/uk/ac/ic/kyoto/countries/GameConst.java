...
public final class GameConst {
	 ...
	 */
	public static final double MONITOR_COST_PERCENTAGE = 0.005;
	 ...
	 */
	public static final double SANCTION_RATE = 0.05;
	
	/**
	 * Price for each monitor
	 */
	public static final double MONITORING_PRICE = 5000;
	
	/**
	 * Number of ticks in a year
	 */
	public static final int TICKS_IN_YEAR = 365;
	
	/**
	 * Number of years in a session
	 */
	public static final int YEARS_IN_SESSION = 10;
	
	/**
	 * Session to session world target reduction
	 */
	public static final double TARGET_REDUCTION = 0.95;
	
	/**
	 * The minimum amount of time, in years, that a country must wait before rejoining Kyoto after leaving
	 */
	public static final int MINIMUM_KYOTO_REJOIN_TIME = 4;
