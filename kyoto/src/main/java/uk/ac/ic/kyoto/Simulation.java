...
public class Simulation extends InjectedSimulation {
	...
	protected void addToScenario(Scenario s) {
		FakeCanadaAgent agent1 = new FakeCanadaAgent(Random.randomUUID(), "FakeCanada1", "FCND1");
		FakeCanadaAgent agent2 = new FakeCanadaAgent(Random.randomUUID(), "FakeCanada2", "FCND2");
